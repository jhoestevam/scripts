...
if %1 == "Java 11" set JAVA_HOME=C:\Program Files (x86)\Java\jdk-11.0.2
...
if %1 == "Java 17" set JAVA_HOME=C:\Program Files (x86)\Java\jdk-17.0.2
...
if %1 == "Java 22" set JAVA_HOME=C:\Program Files (x86)\Java\jdk-22
